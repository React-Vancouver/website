...
export const LAYOUT_TABLET_MAX = '1024px';
export const LAYOUT_DESKTOP_MIN = '1025px';
export const LAYOUT_CONTAINER_MAX = `${LAYOUT_BOUNDRY}px`;
export const LAYOUT_FOOTER_HEIGHT = '8rem';
export const LAYOUT_NAV_HEIGHT = '8rem';
