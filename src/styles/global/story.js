...
storiesOf('Global/Typography', module)
  ...
  .add('dl, dd, dt', () => (
    <Styleguide>
      ...
      <dl>
        <dt>HTML</dt>
        <dd>
          HyperText Markup Language describes the structure of the page and its
          contents.
        </dd>
        <dt>CSS</dt>
        <dd>
          Cascading Style Sheets describes how a site looks and even to some
          extent how it responds to certain events.
        </dd>
        <dt>JavaScript</dt>
        <dd>
  ...
  .add('p', () => (
    <Styleguide>
      ...
      <p>
        Lorem ipsum dolor amet viral blue bottle master cleanse, four loko
        knausgaard twee la croix. Hammock green juice you probably haven’t heard
        of them banjo fixie. Offal raw denim squid flannel poke, kogi fam tofu
        actually. Offal selfies thundercats gochujang raclette cloud bread, raw
        denim locavore. Humblebrag 90’s pabst keffiyeh narwhal tousled. Cliche
        aesthetic artisan tacos mlkshk, sustainable freegan mixtape tattooed
        whatever. Church-key iceland tousled gentrify crucifix la croix, venmo
        distillery.
      </p>
      <p>
        Man braid taiyaki vaporware, squid tilde hot chicken cronut hexagon next
        level photo booth fingerstache sustainable edison bulb cornhole tacos.
        Keytar stumptown roof party hashtag, lumbersexual yuccie hexagon
        whatever four dollar toast 8-bit shabby chic DIY photo booth. Portland
        tilde chartreuse mustache air plant chia. Single-origin coffee venmo
        pinterest hoodie tbh scenester. Chia skateboard green juice kickstarter,
        glossier cardigan food truck. Ugh kickstarter XOXO dreamcatcher celiac
  ...
  .add('img, figure, figcaption', () => (
    <Styleguide>
      ...
      <figure>
        ...
        <figcaption>
          Simple embedding for <a href="https://unsplash.com">Unsplash</a>{' '}
          photos. For a more advanced integration, see{' '}
  ...
  .add('form', () => (
    <Styleguide>
      ...
      <form>
        ...
        <div style={{ marginTop: '3.2rem' }}>
          <label>E-mail:</label>
          <input type="email" placeholder="e.g. jake@adventuretime.com" />
        </div>
        <div style={{ marginTop: '3.2rem' }}>
          <label>Message:</label>
