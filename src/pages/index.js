...
const IndexPage = () => (
  <Shell>
    ...
    <Text element="p" my2>
      ...
      voluptas assumenda? Neque harum reiciendis aliquam repudiandae eius
      nesciunt adipisci, totam vitae quod fuga deserunt voluptates quae eaque
      voluptatum commodi odio!
    </Text>
    <Text element="p" my2>
      Lorem ipsum dolor, sit amet consectetur adipisicing elit. Temporibus nihil
      alias harum eos iure expedita quos tenetur odit fugit culpa. Tempora earum
      dolor suscipit illum delectus ex amet exercitationem enim.
    </Text>
  </Shell>
);
